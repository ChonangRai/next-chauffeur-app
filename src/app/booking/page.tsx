...
export default function BookingPage() {
  ...
  useEffect(() => {
    // Check if we have service details in localStorage
    const serviceDetails = localStorage.getItem('serviceDetails');
    if (!serviceDetails) {
      // No service details, redirect to home
      router.push('/');
      return;
    }
      ...
      try {
        ...
        const response = await fetch("/api/checkout", {
          ...
          body: JSON.stringify({
            ...
            amount: bookingDetails.calculatedAmount || 0,
  ...
  // If no service details, show loading while redirecting
